...
> [!NOTE]
>
> interctions for SvelteKit: [daisyUI | docs / install / sveltekit](<https://raw.githubusercontent.com/saadeghi/daisyui/refs/heads/master/packages/docs/src/routes/(routes)/docs/install/sveltekit/+page.md?plain=1>)
